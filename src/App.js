...
function App() {
  return (
    ...
    <><header className="govuk-header " role="banner" data-module="govuk-header">
      <div className="govuk-header__container govuk-width-container">
        ...
        <div className="govuk-header__content">
          <a href="#" className="govuk-header__link govuk-header__service-name">
            <h2><centre>Book a lightning talk</centre></h2>
          </a>
      ...
      </BrowserRouter> <footer className="govuk-footer " role="contentinfo">
    <div className="govuk-width-container ">
      <div className="govuk-footer__meta">
        ...
        <div className="govuk-footer__meta-item">
          <img src="{% static 'assets/images/govuk-crest-2x.png' %}" className="govuk-header__logotype-crown-fallback-image" width="36" height="32"/>
