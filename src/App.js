...
function App() {
  return (
    ...
    <><header className="govuk-header " role="banner" data-module="govuk-header">
      ...
      </BrowserRouter> <footer class="govuk-footer " role="contentinfo">
    <div class="govuk-width-container ">
      <div class="govuk-footer__meta">
        ...
        <div class="govuk-footer__meta-item">
          <img src="{% static 'assets/images/govuk-crest-2x.png' %}" class="govuk-header__logotype-crown-fallback-image" width="36" height="32"/>
